...
function runSpecs() {
  ...
  browser.params = defaultConfig.params;
  ...
  webdriver.promise.controlFlow().execute(function () {
    if (defaultConfig.beforeStart) {
      if (typeof defaultConfig.beforeStart === 'function') {
        defaultConfig.beforeStart();
      } else if (typeof defaultConfig.beforeStart === 'string') {
        require(path.resolve(defaultConfig.configDir, defaultConfig.beforeStart));
      } else {
