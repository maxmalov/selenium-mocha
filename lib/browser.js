...
function Browser(webdriver, baseUrl) {
  ...
  webdriver.getCapability('browserName').then(function (value) {
      this.name = value;
  }.bind(this));
}
...
Browser.prototype.waitForElement = function (locator) {
 ...
 * @returns {boolean}
 */
Browser.prototype.is = function (list) {
    return list.indexOf(this.name) !== -1;
};
